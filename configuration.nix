...
# TO-DO:
# - GUEST ACCOUNT HOME-MANAGER BROKEN?
# - Set up OBS
# - Install nixGL
# - Fix Aseprite Theme
...
# swapon /dev/sda2
# -- CONFIGURATION -- #
# »»» /mnt/etc/nixos/configuration.nix (after: nixos-generate-config --root /mnt)
# nixos-install
# reboot
...
{ config, pkgs, ... }:
{
  ...
  home-manager.users.guest = {
    ...
    home.file.".wallpaper.png" = {
      source = builtins.fetchurl {
        url = "https://github.com/Gingeh/wallpapers/blob/main/os/tux-magenta-pink-1920x1080.png?raw=true";
      };
    };
  ...
  system.nixos.label = "MeowOS-2.0.0-MaineCoon";
    # CHANGELOG:
    #   - MeowOS v.2.0.0
    #     - Guest Account
    #     - Remove Games
